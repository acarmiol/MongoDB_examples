...
function addCategory(e) {
    ...
    $.ajax({
        url: `https://api.mlab.com/api/1/databases/taskmanager01/collections/categories?apiKey=${apiKey}`,
        data: JSON.stringify({
...
function getCategory(id) {
    ...
    $.get(`https://api.mlab.com/api/1/databases/taskmanager01/collections/categories/${id}?apiKey=${apiKey}`, function(category) {
...
function editCategory(e) {
    ...
    $.ajax({
        url: `https://api.mlab.com/api/1/databases/taskmanager01/collections/categories/${id}?apiKey=${apiKey}`,
        data: JSON.stringify({
            "category_name": category_name,
